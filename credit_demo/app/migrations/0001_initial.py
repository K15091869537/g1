# Generated by Django 2.0.7 on 2020-11-19 12:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('banner', models.CharField(max_length=500, null=True, verbose_name='轮播图存储路径')),
            ],
        ),
        migrations.CreateModel(
            name='Apply_progress',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('breaks', models.IntegerField(verbose_name='是否发起减免申请')),
                ('b_reason', models.CharField(max_length=100, verbose_name='减免理由')),
                ('b_through', models.IntegerField(verbose_name='是否通过减免')),
                ('delay', models.IntegerField(verbose_name='是否发起展期申请')),
                ('d_reason', models.CharField(max_length=100, verbose_name='展期理由')),
                ('d_through', models.IntegerField(default=0, verbose_name='是否通过展期')),
            ],
        ),
        migrations.CreateModel(
            name='Coupons',
            fields=[
                ...
                ('discount', models.CharField(max_length=20, null=True, verbose_name='折扣')),
                ('c_num', models.IntegerField(null=True, verbose_name='优惠券数量')),
            ],
        ),
        migrations.CreateModel(
            name='Coupons_type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation', models.CharField(max_length=100, null=True, verbose_name='操作')),
                ('Uid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户ID')),
            ],
        ),
        migrations.CreateModel(
            name='News',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.IntegerField(null=True, verbose_name='贷款周期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Cid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Coupons', verbose_name='优惠券')),
                ('Uid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Auth_user', verbose_name='用户ID')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='breaks',
            name='Lid',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Laundry_list', verbose_name='流水ID'),
        ),
        migrations.AddField(
            model_name='auth_user_emp_reply',
            name='Rid',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Reply', verbose_name='回复信息ID'),
        ),
        migrations.AddField(
            model_name='auth_user_emp_reply',
            name='Uid',
